...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Last orchestrator step number to run.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--mvp",
        action="store_true",
        help="Run from existing shared raw data using the MVP database and MVP validation outputs.",
    )
